...
import { ListGroup, ListGroupItem, Overlay, Pager, Pagination } from 'react-bootstrap';
...
var ToggleButton = function ToggleButton(_ref) {
  ...
  return createElement(
    ...
    createElement('i', { className: 'glyphicon glyphicon-eye-close' })
  );
};
...
var renderPageButtons = function renderPageButtons(currentPage, totalPageCount, onCurrentPageChange) {
  ...
  if (startPage > 1) {
    ...
    if (startPage > 2) {
      pageButtons.push(createElement(Pagination.Ellipsis, { key: 'ellipsisStart', disabled: true }));
    }
  }
  ...
  if (endPage < totalPageCount) {
    if (endPage < totalPageCount - 1) {
      pageButtons.push(createElement(Pagination.Ellipsis, { key: 'ellipsisEnd', disabled: true }));
    }
    ...
    value: function render() {
      ...
      return createElement(
        ...
        createElement(
          ...
          createElement(ResizingControlLine, { resizing: resizing, style: { left: '6px' } }),
          createElement(ResizingControlLine, { resizing: resizing, style: { left: '8px' } })
        )
      );
    }
  }]);
...
var InvisibleCell = function InvisibleCell() {
  return createElement('th', { style: { display: 'none' } });
};
