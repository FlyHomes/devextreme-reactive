...
export namespace TableHeaderRow {
  ...
  export interface CellProps extends Table.CellProps {
    ...
    column: Column;
    /** Specifies whether to display a button that groups data by the column. */
    showGroupingControls: boolean;
    /** Specifies whether grouping by the column is enabled. */
    groupingEnabled: boolean;
    /** An event that invokes grouping by the column. */
    onGroup: () => void;
