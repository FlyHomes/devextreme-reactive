...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@devexpress/dx-vue-core'), require('@devexpress/dx-grid-core')) :
	typeof define === 'function' && define.amd ? define(['exports', '@devexpress/dx-vue-core', '@devexpress/dx-grid-core'], factory) :
	(factory((global.DevExpress = global.DevExpress || {}, global.DevExpress.DXVueGrid = {}),global.DevExpress.DXVueCore,global.DevExpress.DXGridCore));
}(this, (function (exports,dxVueCore,dxGridCore) { 'use strict';
...
var GridCore = {
  ...
  render: function render() {
    ...
    return h(dxVueCore.DxPlugin, [h(dxVueCore.DxGetter, {
      attrs: { name: 'rows', value: rows }
    }), h(dxVueCore.DxGetter, {
      attrs: { name: 'getRowId', value: dxGridCore.rowIdGetter(getRowId, rows) }
    }), h(dxVueCore.DxGetter, {
      attrs: { name: 'columns', value: columns }
    }), h(dxVueCore.DxGetter, {
      attrs: { name: 'getCellValue', value: dxGridCore.cellValueGetter(getCellValue, columns) }
    }), h(
      dxVueCore.DxTemplate,
      {
        attrs: { name: 'root' }
      },
      [h(Root, [h(dxVueCore.DxTemplatePlaceholder, {
        attrs: { name: 'header' }
      }), h(dxVueCore.DxTemplatePlaceholder, {
        attrs: { name: 'body' }
      }), h(dxVueCore.DxTemplatePlaceholder, {
        attrs: { name: 'footer' }
      })])]
...
var DxGrid = {
  ...
  render: function render(h, context) {
    return h(dxVueCore.DxPluginHost, [h(GridCore, context.data), context.children]);
  }
};
...
var RowPlaceholder = {
  ...
  render: function render() {
    ...
    return h(
      dxVueCore.DxTemplatePlaceholder,
...
var CellPlaceholder = {
  ...
  render: function render() {
    ...
    return h(dxVueCore.DxTemplatePlaceholder, babelHelperVueJsxMergeProps([{
      attrs: {
        name: 'tableCell'
      }
    }, { attrs: _extends({}, this.$props) }]));
  ...
  render: function render() {
    ...
    return h(
      ...
      [h(dxVueCore.DxGetter, {
        ...
        attrs: { name: 'getTableCellColSpan', value: dxGridCore.tableCellColSpanGetter }
      }), h(
        dxVueCore.DxTemplate,
        {
          attrs: { name: 'body' }
        ...
        [h(dxVueCore.DxTemplateConnector, [function (_ref3) {
        ...
        [function (_ref4) {
          ...
          return h(dxVueCore.DxTemplateConnector, [function (_ref5) {
            var headerRows = _ref5.getters.tableHeaderRows;
            return dxGridCore.isHeaderStubTableCell(attrs.tableRow, headerRows) ? h(StubHeaderCell, { attrs: _extends({}, attrs), on: _extends({}, listeners) }) : h(StubCell, { attrs: _extends({}, attrs), on: _extends({}, listeners) });
          }]);
        }]
      ), h(
        dxVueCore.DxTemplate,
        ...
        [function (_ref7) {
          ...
          return h(dxVueCore.DxTemplateConnector, [function (_ref8) {
        ...
        [function (_ref10) {
          ...
          return h(dxVueCore.DxTemplateConnector, [function (_ref11) {
            var tableColumns = _ref11.getters.tableColumns;

            if (dxGridCore.isNoDataTableCell(attrs.tableColumn, tableColumns)) {
    ...
    return h(
      ...
      [h(dxVueCore.DxGetter, {
        ...
        [function (_ref3) {
          ...
          return h(dxVueCore.DxTemplateConnector, [function (_ref4) {
            ...
            return h(
              ...
              babelHelperVueJsxMergeProps([{ attrs: _extends({}, attrs), on: _extends({}, listeners) }, {
                attrs: {
                  ...
                  sortingDirection: _this.showSortingControls ? dxGridCore.getColumnSortingDirection(sorting, columnName) : undefined
                },
                on: {
...
var DxSortingState = {
  ...
  methods: {
    changeColumnSorting: function changeColumnSorting$$1(payload) {
      var persistentSortedColumns = dxGridCore.getPersistentSortedColumns(this.sorting, this.columnExtensions);
      var keepOther = dxGridCore.calculateKeepOther(this.sorting, payload.keepOther, persistentSortedColumns);
      this.$emit('update:sorting', dxGridCore.changeColumnSorting({ sorting: this.sorting }, _extends({}, payload, { keepOther: keepOther })).sorting);
    }
  },
  ...
  render: function render() {
    ...
    var columnExtensionValueGetter = function columnExtensionValueGetter(extensions, defaultValue) {
      return dxGridCore.getColumnExtensionValueGetter(extensions, 'sortingEnabled', defaultValue);
    };
...
var VirtualTableLayout = {
  ...
  render: function render() {
    ...
    return h(dxVueCore.DxSizer, [function (_ref5) {
...
var DxFilteringState = {
  ...
  methods: {
    changeColumnFilter: function changeColumnFilter$$1(payload) {
      this.$emit('update:filters', dxGridCore.changeColumnFilter(this.filters, payload));
    }
  },
  render: function render() {
    var h = arguments[0];
...
DxIntegratedFiltering.defaultPredicate = dxGridCore.defaultFilterPredicate;
        ...
        [function (_ref3) {
          ...
          return h(dxVueCore.DxTemplateConnector, [function (_ref4) {
            ...
            var handleFilterValueChange = function handleFilterValueChange(value) {
              onFilter(!dxGridCore.isFilterValueEmpty(value) ? { value: value, operation: selectedFilterOperation } : null);
            };
...
var DxGroupingState = {
  ...
  methods: {
    ...
    changeColumnGrouping: function changeColumnGrouping$$1(_ref8, getters, actions) {
      ...
      var stateChange = dxGridCore.changeColumnGrouping(prevState, { columnName: columnName, groupingIndex: groupingIndex });
    ...
    toggleGroupExpanded: function toggleGroupExpanded(_ref9) {
      ...
      this.$emit('update:expandedGroups', dxGridCore.toggleExpandedGroups({ expandedGroups: this.expandedGroups }, { groupKey: groupKey }).expandedGroups);
    }
  },
  render: function render() {
    var h = arguments[0];
...
var DxIntegratedGrouping = {
  ...
  render: function render() {
    ...
    return h(
      ...
      [h(dxVueCore.DxGetter, {
        attrs: { name: 'isGroupRow', value: dxGridCore.groupRowChecker }
      }), h(dxVueCore.DxGetter, {
        attrs: { name: 'getRowLevelKey', value: dxGridCore.groupRowLevelKeyGetter }
      }), h(dxVueCore.DxGetter, {
  ...
  render: function render() {
    ...
    var ItemPlaceholder = {
      ...
      render: function render() {
        ...
        return h(dxVueCore.DxTemplateConnector, [function (_ref) {
      ...
      [h(
        ...
        [h(
          ...
          [h(dxVueCore.DxTemplateConnector, [function (_ref3) {
            ...
            return h(Layout, {
              attrs: {
                items: dxGridCore.groupingPanelItems(columns, grouping, []),
  ...
  render: function render() {
    ...
    var tableColumnsComputed = function tableColumnsComputed(_ref3) {
      var columns = _ref3.columns,
          ...
          grouping = _ref3.grouping;
      return dxGridCore.tableColumnsWithGrouping(columns, tableColumns, grouping, grouping, indentColumnWidth, showColumnWhenGroupedGetter(showColumnsWhenGrouped, columnExtensions));
    };
    return h(
      dxVueCore.DxPlugin,
      {
      ...
      [h(dxVueCore.DxGetter, {
        ...
        [function (_ref5) {
          ...
          return h(dxVueCore.DxTemplateConnector, [function (_ref6) {
            ...
            if (dxGridCore.isGroupTableCell(attrs.tableRow, attrs.tableColumn)) {
              return h(
                dxVueCore.DxTemplatePlaceholder,
                {
                  attrs: {
            ...
            if (dxGridCore.isGroupIndentTableCell(attrs.tableRow, attrs.tableColumn, grouping)) {
              if (GroupIndentCell) {
              ...
              return h(dxVueCore.DxTemplatePlaceholder);
            }
            return null;
          }]);
        }]
...
var DxSearchState = {
  ...
  methods: {
    changeValue: function changeValue(payload) {
      this.$emit('update:value', dxGridCore.changeSearchValue(this.value, payload));
    }
  },
  render: function render() {
    var h = arguments[0];
    ...
    return h(
      ...
      [h(
        ...
        [h(
          'div',
          { style: { display: 'flex', flex: 1 } },
          [h(dxVueCore.DxTemplatePlaceholder), h(dxVueCore.DxTemplateConnector, [function (_ref) {
...
var DxSelectionState = {
  ...
  methods: {
    toggleSelection: function toggleSelection$$1(payload) {
      this.$emit('update:selection', dxGridCore.toggleSelection(this.selection, payload));
    }
  },
  render: function render() {
    var h = arguments[0];
...
var DxTableSelection = {
  ...
  render: function render() {
    ...
    return h(
      ...
      [showSelectionColumn && h(dxVueCore.DxGetter, {
        attrs: { name: 'tableColumns', computed: tableColumnsComputed }
        ...
        [function (_ref6) {
          var attrs = _ref6.attrs,
              listeners = _ref6.listeners;
          return h(dxVueCore.DxTemplateConnector, [function (_ref7) {
        ...
        [function (_ref9) {
          var attrs = _ref9.attrs,
              ...
              slots = _ref9.slots;
          return h(dxVueCore.DxTemplateConnector, [function (_ref10) {
...
var DxPagingState = {
  ...
  methods: {
    setCurrentPage: function setCurrentPage$$1(payload) {
      this.$emit('update:currentPage', dxGridCore.setCurrentPage(this.currentPage, payload));
    },
    setPageSize: function setPageSize$$1(payload) {
      this.$emit('update:pageSize', dxGridCore.setPageSize(this.pageSize, payload));
    }
  },
  render: function render() {
    var h = arguments[0];
  ...
  render: function render() {
    ...
    return h(
      ...
      [h(
        ...
        [h('div', [' ', h(dxVueCore.DxTemplatePlaceholder), h(dxVueCore.DxTemplateConnector, [function (_ref) {
          var _ref$getters = _ref.getters,
...
var DxRowDetailState = {
  ...
  methods: {
    toggleDetailRowExpanded: function toggleDetailRowExpanded$$1(payload) {
      this.$emit('update:expandedRowIds', dxGridCore.toggleDetailRowExpanded(this.expandedRowIds, payload));
    }
  },
  render: function render() {
    var h = arguments[0];
    ...
    return h(
      ...
      [h(dxVueCore.DxGetter, {
        ...
        [function (_ref5) {
          ...
          return h(dxVueCore.DxTemplateConnector, [function (_ref6) {
            ...
            return h(ToggleCell, babelHelperVueJsxMergeProps([{ attrs: _extends({}, attrs), on: _extends({}, listeners) }, {
              attrs: {
                row: attrs.tableRow.row,
                expanded: dxGridCore.isDetailRowExpanded(expandedDetailRowIds, attrs.tableRow.rowId)
              },
              on: {
                'toggle': function toggle() {
        ...
        [function (_ref8) {
          var attrs = _ref8.attrs,
              listeners = _ref8.listeners;
          return h(dxVueCore.DxTemplateConnector, [function (_ref9) {
            var tableColumns = _ref9.getters.tableColumns;

            if (dxGridCore.isDetailTableCell(attrs.tableColumn, tableColumns)) {
              return h(
                Cell,
                babelHelperVueJsxMergeProps([{ attrs: _extends({}, attrs), on: _extends({}, listeners) }, {
                  attrs: {
...
var DxEditingState = {
  ...
  methods: {
    startEditRows: function startEditRows$$1(payload) {
      this.$emit('update:editingRowIds', dxGridCore.startEditRows(this.editingRowIds, payload));
    },
    stopEditRows: function stopEditRows$$1(payload) {
      this.$emit('update:editingRowIds', dxGridCore.stopEditRows(this.editingRowIds, payload));
    },
    changeRow: function changeRow$$1(payload) {
      this.$emit('update:rowChanges', dxGridCore.changeRow(this.rowChanges, payload));
    },
    cancelChangedRows: function cancelChangedRows(payload) {
      this.$emit('update:rowChanges', dxGridCore.cancelChanges(this.rowChanges, payload));
    },
    commitChangedRows: function commitChangedRows(_ref) {
      var rowIds = _ref.rowIds;

      this.$emit('commitChanges', { changed: dxGridCore.changedRowsByIds(this.rowChanges, rowIds) });
      this.cancelChangedRows({ rowIds: rowIds });
    },
    addRow: function addRow$$1(payload) {
      this.$emit('update:addedRows', dxGridCore.addRow(this.addedRows, payload));
    },
    changeAddedRow: function changeAddedRow$$1(payload) {
      this.$emit('update:addedRows', dxGridCore.changeAddedRow(this.addedRows, payload));
    },
    cancelAddedRows: function cancelAddedRows$$1(payload) {
      this.$emit('update:addedRows', dxGridCore.cancelAddedRows(this.addedRows, payload));
    },
    commitAddedRows: function commitAddedRows(_ref2) {
      var rowIds = _ref2.rowIds;

      this.$emit('commitChanges', { added: dxGridCore.addedRowsByIds(this.addedRows, rowIds) });
      this.cancelAddedRows({ rowIds: rowIds });
    },
    deleteRows: function deleteRows$$1(payload) {
      this.$emit('update:deletedRowIds', dxGridCore.deleteRows(this.deletedRowIds, payload));
    },
    cancelDeletedRows: function cancelDeletedRows$$1(payload) {
      this.$emit('update:deletedRowIds', dxGridCore.cancelDeletedRows(this.deletedRowIds, payload));
    },
      ...
      [h(dxVueCore.DxGetter, {
        ...
        [function (_ref6) {
          ...
          return h(dxVueCore.DxTemplateConnector, [function (_ref7) {
            ...
            var isEdit = dxGridCore.isEditTableRow(attrs.tableRow);
            var isNew = dxGridCore.isAddedTableRow(attrs.tableRow);
...
var DxTreeDataState = {
  ...
  methods: {
    toggleRowExpanded: function toggleRowExpanded$$1(payload) {
      this.$emit('update:expandedRowIds', dxGridCore.toggleRowExpanded(this.expandedRowIds, payload));
    }
  },
  render: function render() {
    var h = arguments[0];
    ...
    return h(
      ...
      [h(
        ...
        [h(
          ...
          }), showSelectionControls && showSelectAll && h(dxVueCore.DxTemplateConnector, [function (_ref2) {
      ...
      [h(dxVueCore.DxGetter, {
        ...
        [function (_ref3) {
          ...
          return h(dxVueCore.DxTemplateConnector, [function (_ref4) {
            ...
            var bandComponent = dxGridCore.getBandComponent(attrs, tableHeaderRows, tableColumns, columnBands);
...
var DxTableColumnVisibility = {
  ...
  methods: {
    toggleColumnVisibility: function toggleColumnVisibility(columnName) {
      this.$emit('update:hiddenColumnNames', dxGridCore.toggleColumn(this.hiddenColumnNames, columnName));
    }
  },
  render: function render() {
    var h = arguments[0];
    ...
    return h(
      ...
      [h(dxVueCore.DxGetter, {
        ...
        [function (attrs) {
          return h(dxVueCore.DxTemplateConnector, [function (_ref2) {
            var tableColumns = _ref2.getters.tableColumns;
            return dxGridCore.tableDataColumnsExist(tableColumns) ? h(dxVueCore.DxTemplatePlaceholder) : h(EmptyMessage, babelHelperVueJsxMergeProps([{
              attrs: {
                getMessage: getMessage
              }
            }, { attrs: attrs }]));
          ...
          [h(dxVueCore.DxTemplatePlaceholder), h(dxVueCore.DxTemplateConnector, [function (_ref) {
            ...
            return h(
              ...
              [h(ToggleButton, {
                ...
                [h(Container, [dxGridCore.columnChooserItems(columns, hiddenColumnNames).map(function (item) {
                  var columnName = item.column.name;
...
exports.DxTable = DxTable;
exports.DxTableHeaderRow = DxTableHeaderRow;
exports.DxIntegratedSorting = DxIntegratedSorting;
exports.DxSortingState = DxSortingState;
...
exports.DxFilteringState = DxFilteringState;
exports.DxIntegratedFiltering = DxIntegratedFiltering;
exports.DxTableFilterRow = DxTableFilterRow;
exports.DxGroupingState = DxGroupingState;
exports.DxIntegratedGrouping = DxIntegratedGrouping;
exports.DxCustomGrouping = DxCustomGrouping;
exports.DxGroupingPanel = DxGroupingPanel;
exports.DxTableGroupRow = DxTableGroupRow;
exports.GroupPanelLayout = GroupPanelLayout;
exports.DxSearchState = DxSearchState;
exports.DxSearchPanel = DxSearchPanel;
exports.DxSelectionState = DxSelectionState;
exports.DxIntegratedSelection = DxIntegratedSelection;
exports.DxTableSelection = DxTableSelection;
exports.DxPagingState = DxPagingState;
exports.DxIntegratedPaging = DxIntegratedPaging;
exports.DxCustomPaging = DxCustomPaging;
exports.DxPagingPanel = DxPagingPanel;
exports.DxDataTypeProvider = DxDataTypeProvider;
exports.DxRowDetailState = DxRowDetailState;
exports.DxTableRowDetail = DxTableRowDetail;
exports.DxEditingState = DxEditingState;
exports.DxTableEditColumn = DxTableEditColumn;
exports.DxTableEditRow = DxTableEditRow;
exports.DxTreeDataState = DxTreeDataState;
exports.DxCustomTreeData = DxCustomTreeData;
exports.DxTableTreeColumn = DxTableTreeColumn;
exports.DxTableBandHeader = DxTableBandHeader;
exports.DxTableColumnVisibility = DxTableColumnVisibility;
exports.DxColumnChooser = DxColumnChooser;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=dx-vue-grid.umd.js.map
